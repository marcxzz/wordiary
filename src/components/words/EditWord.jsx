    ...
    <>
      ...
      <div className="flex rounded-2xl dark:bg-gray-700 border border-gray-600 overflow-hidden mt-2">
        <div className="p-1 flex w-full">
          ...
          <input type="text" placeholder="Type the translation..." value={translation || ''} id="translationInput" className="w-full outline-none dark:text-white text-sm" required maxLength={100} onChange={(event) => handleTranslationUpdate(event)} />
        </div>
